...
class Net(nn.Module):
    ...
    def __init__(self, n_classes=50):
        ...
        # network setup
        self.conv1 = nn.Conv1d(1, 32, 64, stride=2, bias=False)
        self.bn1 = nn.BatchNorm1d(32)
        self.elu1 = nn.ELU()
        self.conv2 = nn.Conv1d(32, 64, 16, stride=2, bias=False)
...
class Netv1(nn.Module):
    ...
    def __init__(self, n_classes=50):
        ...
        # network setup
        self.conv1 = nn.Conv1d(1, 40, 8, bias=False, padding=0)
        self.bn1 = nn.BatchNorm1d(40)
        self.elu1 = nn.ELU()
        self.conv2 = nn.Conv1d(40, 40, 8, bias=False)
        ...
        self.elu4 = nn.ELU()
        self.fc5 = nn.Linear(50*14*11, 4096)
